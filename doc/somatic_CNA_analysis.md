...
__This part is explanation of the weird plots you will get in the folder with `baf` files you've specified. If you run `ClinCNV` for the first time, you may skip this part.__
...
__This section describes the BAF tracks generated for IGV visualization. May be skipped in the beginning.__
...
__This part describes clonal structure of sample and the plots describing the sub-clonal structure generated by ClinCNV__
